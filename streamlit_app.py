...
with col2:
    ...
    st.markdown("<p style='font-size:14px;'>This web-based calculator was developed based on an SVM model with an AUC of 0.91 for predicting 3-year mortality in B-type aortic dissection patients.</p>", unsafe_allow_html=True)
